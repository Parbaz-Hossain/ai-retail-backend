...
class EmployeeCreateForm:
    def __init__(
        ...
        date_of_birth: Optional[date] = Form(None, description="Date of birth (YYYY-MM-DD)", example="1990-05-15"),
        hire_date: date = Form(..., description="Hire date (YYYY-MM-DD)", example="2024-10-01"),
