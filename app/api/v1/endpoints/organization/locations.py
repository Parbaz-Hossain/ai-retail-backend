...
from app.schemas.organization.location_schema import LocationCreate, LocationUpdate, LocationSpecificResponse
from app.models.auth.user import User

router = APIRouter()

@router.post("/", response_model=LocationSpecificResponse)
...
@router.get("/", response_model=PaginatedResponse[LocationSpecificResponse])
...
@router.get("/branches", response_model=List[LocationSpecificResponse])
...
@router.get("/warehouses", response_model=List[LocationSpecificResponse])
...
@router.get("/{location_id}", response_model=LocationSpecificResponse)
...
@router.put("/{location_id}", response_model=LocationSpecificResponse)
